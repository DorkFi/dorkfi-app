...
The Algorand service provides a centralized way to manage Algorand Algod and Indexer clients across different networks (Mainnet, Testnet, Local, VOI Mainnet).
