...
export default function LiquidationHeroSection() {
  return (
    <DorkFiCard 
      elevation="md"
      hoverable
    ...
    >
      ...
      <div className="relative z-10">
        <H1 className="m-0 text-4xl md:text-5xl">
          <span className="hero-header">Liquidation Markets</span>
        </H1>
        <Body className="text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl mx-auto">
          Track risky loans across DorkFi and act before they're liquidated.<br />
          Repay bad debt to earn liquidation rewards and keep the system healthy.
        </Body>
      </div>
    </DorkFiCard>
  );
