...
import { EasyStartBridgeSheet } from "@/components/easy-start/EasyStartBridgeSheet";
...
export function EasyStartButton() {
  const { ready, login } = usePrivyEasyStart();
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-72">
          ...
          <DropdownMenuItem onClick={() => setBridgeOpen(true)}>
      ...
      <EasyStartDepositSheet
        ...
        onContinueToBridge={() => setBridgeOpen(true)}
      />
      <EasyStartBridgeSheet open={bridgeOpen} onOpenChange={setBridgeOpen} />
    </>
  );
}
