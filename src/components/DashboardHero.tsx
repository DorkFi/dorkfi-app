...
const DashboardHero: React.FC<DashboardHeroProps> = ({
  ...
  <div className="relative bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-[hsl(var(--deep-sea-navy))] dark:to-[hsl(var(--ocean-floor))] rounded-xl p-6 md:p-8 text-center overflow-hidden min-h-[300px] md:min-h-[360px] flex flex-col items-center justify-center border border-gray-200/50 dark:border-ocean-teal/20 card-hover hover:border-ocean-teal/40 transition-all">
    ...
    <div
      className="absolute top-6 left-10 opacity-80 pointer-events-none z-0 animate-bubble-float dark:hidden"
    ...
    <div
      className="absolute top-12 right-16 opacity-80 pointer-events-none z-0 animate-bubble-float dark:hidden"
    ...
    <div
      className="absolute top-4 right-4 opacity-50 pointer-events-none z-0 animate-bubble-float dark:hidden"
    ...
    <div
      className="absolute top-10 right-12 w-12 h-12 md:w-16 md:h-16 rounded-full bg-ocean-teal/10 animate-pulse"
